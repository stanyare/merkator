...
var handler = function(){
	...
	if (viewport_wid <= 640) {
		if($('.js-category').length){
			var $numberNews = $('.box-category-list .numbers-news');
	...
	if (viewport_wid <= 640) {
		if($('.js-subcategory').length){
			var $numberNews = $('.number-slide-subcategory .numbers-news');
			var $slickNews = $('.js-subcategory');
